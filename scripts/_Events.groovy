...
eventCompileStart = { GantBinding compileBinding ->
    ...
    try {
        def sourceDir = (compileBinding.variables.nestedsetPluginDir?.absolutePath ?: basedir) + '/src/groovy'
        def destDir = grailsSettings.projectWorkDir.absolutePath + "/plugin-classes"

        ant.mkdir(dir: destDir)
        grailsConsole.addStatus "Precompiling Nestedset AST transforms..."
